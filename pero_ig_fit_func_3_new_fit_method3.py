...
In this file, I use the scopy.optimze.minimize to do the fit
...
def pero_sep( wvb,C_A,C_B,R_ion, C_g , J_s , nA,vb, data):
...
def global_fit(dfs, init_guess, fix_index):
    ...
    res = minimize(lambda C_A,C_B,R_ion, C_g , J_s , nA,vb: pero_sep(wvlist_big[:,0],C_A,C_B,R_ion, C_g , J_s , nA,vb,Zlist_big) , init_guess , method='Nelder-Mead', tol=1e-6)
